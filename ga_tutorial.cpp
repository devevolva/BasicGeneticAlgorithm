    ...
    #define CROSSOVER_RATE            0.75          //0.7   
    #define MUTATION_RATE             0.001         //0.001   
    #define POP_SIZE                  100           //100_must be an even number   
    #define CHROMO_LENGTH             300           //300   
    #define GENE_LENGTH               4             //4   
    #define MAX_ALLOWABLE_GENERATIONS   400         //400   
